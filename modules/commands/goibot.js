...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "anh Triết") || (event.body.toLowerCase() == "anh dang")) {
  ...
  if ((event.body.toLowerCase() == "a Triết") || (event.body.toLowerCase() == "a Triết")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "Triết") || (event.body.toLowerCase() == "dang")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "@Nguyễn Minh Triết") || (event.body.toLowerCase() == "@NGUYEN MINH TRIET")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag anh ấy mà hãy liên hệ qua Fb: https://www.facebook.com/alotritne ", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Nguyễn Minh Triết có gì dùng lệnh -ad hoặc -adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ông Triết") || (event.body.toLowerCase() == "ong Dang")) {
    return api.sendMessage("️Kêu chủ của tôi gì á :)?", threadID);
  };

  if ((event.body.toLowerCase() == "ôg Triết") || (event.body.toLowerCase() == "og Dang")) {
